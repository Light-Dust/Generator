...
class TAG_Float(TAG):
    ...
    def __str__(self) -> str:
        return f'{self.__name__}: {str(self.__value__)}f'
...
class TAG_Double(TAG):
    ...
    def __str__(self) -> str:
        return f'{self.__name__}: {str(self.__value__)}d'
